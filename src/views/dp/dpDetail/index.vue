...
<script>
import { getDataProvider, getAllDataProviderMethod } from '@/api/providers'
...
export default {
  ...
  methods: {
    ...
    handleClick(data) {
      ...
      this.$router.push({ path: `/ap-dp/dateset-detail/${this.did}/${data.method}` })
      return data
    },
    ...
    async handlerGetInfo() {
      const result = await getDataProvider(this.did)
      console.log('result', result)
      this.info = result.data.getDataProvider
    },
    async handlerGetMethods() {
      const result = await getAllDataProviderMethod({
        pageNumber: this.pageNumber,
        pageSize: this.pageSize,
        did: this.did
      })
      this.list = result.data.getAllDataProviderMethod.data
      this.total = result.data.getAllDataProviderMethod.total
